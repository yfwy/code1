...
func (c *MainController) HandleLogin()  {
	...
	if check == "on"{
		c.Ctx.SetCookie("userName",userName,time.Second*10000)
	}else {
...
func (c *MainController)ShowContent()  {
	userName1 :=c.GetSession("userName")
	if userName1 == nil{
		c.Redirect("/login.html",302)
		return
	}
...
func (c *MainController)HandleTypeDelete(){
	Id,_ := c.GetInt("id")
	var artiT models.ArticleType
	artiT.Id =Id
	o := orm.NewOrm()
	err :=o.Read(&artiT)
	if err != nil{
